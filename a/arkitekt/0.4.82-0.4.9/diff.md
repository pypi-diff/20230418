# Comparing `tmp/arkitekt-0.4.82.tar.gz` & `tmp/arkitekt-0.4.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "arkitekt-0.4.82.tar", max compression
+gzip compressed data, was "arkitekt-0.4.9.tar", max compression
```

## Comparing `arkitekt-0.4.82.tar` & `arkitekt-0.4.9.tar`

### file list

```diff
@@ -1,59 +1,45 @@
--rw-r--r--   0        0        0      299 2023-03-03 13:17:21.627407 arkitekt-0.4.82/arkitekt/__init__.py
--rw-r--r--   0        0        0       54 2022-09-28 15:15:28.986749 arkitekt-0.4.82/arkitekt/apps/__init__.py
--rw-r--r--   0        0        0      634 2023-03-10 11:35:23.703615 arkitekt-0.4.82/arkitekt/apps/connected.py
--rw-r--r--   0        0        0      979 2022-11-21 14:18:14.617734 arkitekt-0.4.82/arkitekt/apps/default.py
--rw-r--r--   0        0        0      299 2023-03-10 11:35:23.703615 arkitekt-0.4.82/arkitekt/apps/fakts.py
--rw-r--r--   0        0        0     1869 2023-03-10 11:35:23.703615 arkitekt-0.4.82/arkitekt/apps/fluss.py
--rw-r--r--   0        0        0      293 2023-03-10 11:35:23.703615 arkitekt-0.4.82/arkitekt/apps/herre.py
--rw-r--r--   0        0        0     2842 2023-02-14 16:53:09.149069 arkitekt-0.4.82/arkitekt/apps/mikro.py
--rw-r--r--   0        0        0     2274 2022-12-15 15:50:35.665918 arkitekt-0.4.82/arkitekt/apps/rekuest.py
--rw-r--r--   0        0        0      976 2023-03-10 11:35:23.703615 arkitekt-0.4.82/arkitekt/apps/unlok.py
--rw-r--r--   0        0        0    11346 2023-04-15 21:18:41.026634 arkitekt-0.4.82/arkitekt/builders.py
--rw-r--r--   0        0        0        0 2022-08-25 10:31:18.672462 arkitekt-0.4.82/arkitekt/cli/__init__.py
--rw-r--r--   0        0        0     5962 2023-03-30 09:24:17.794873 arkitekt-0.4.82/arkitekt/cli/build.py
--rw-r--r--   0        0        0    11011 2023-03-09 14:31:34.404795 arkitekt-0.4.82/arkitekt/cli/configs/introspect.yaml
--rw-r--r--   0        0        0    11054 2023-03-09 14:32:34.036965 arkitekt-0.4.82/arkitekt/cli/configs/latest.yaml
--rw-r--r--   0        0        0    11126 2023-03-09 14:46:09.667053 arkitekt-0.4.82/arkitekt/cli/configs/minimal.yaml
--rw-r--r--   0        0        0     3147 2023-03-30 10:04:52.303630 arkitekt-0.4.82/arkitekt/cli/deploy.py
--rw-r--r--   0        0        0     6916 2023-04-18 14:14:41.677229 arkitekt-0.4.82/arkitekt/cli/dev.py
--rw-r--r--   0        0        0     5546 2023-03-10 11:35:23.703615 arkitekt-0.4.82/arkitekt/cli/gen.py
--rw-r--r--   0        0        0     1355 2023-03-30 02:16:07.818458 arkitekt-0.4.82/arkitekt/cli/init.py
--rw-r--r--   0        0        0     1476 2023-03-30 08:40:09.488953 arkitekt-0.4.82/arkitekt/cli/inspect.py
--rw-r--r--   0        0        0    19989 2023-04-18 14:49:02.353932 arkitekt-0.4.82/arkitekt/cli/main.py
--rw-r--r--   0        0        0     1952 2023-04-13 12:20:15.497793 arkitekt-0.4.82/arkitekt/cli/run.py
--rw-r--r--   0        0        0      871 2023-03-10 11:35:23.703615 arkitekt-0.4.82/arkitekt/cli/scan.py
--rw-r--r--   0        0        0    23235 2023-03-09 13:31:49.692385 arkitekt-0.4.82/arkitekt/cli/schemas/latest/fluss.schema.graphql
--rw-r--r--   0        0        0     5187 2023-03-09 13:31:49.692385 arkitekt-0.4.82/arkitekt/cli/schemas/latest/kuay.schema.graphql
--rw-r--r--   0        0        0   100011 2023-03-09 13:31:49.692385 arkitekt-0.4.82/arkitekt/cli/schemas/latest/mikro.schema.graphql
--rw-r--r--   0        0        0    50701 2023-03-09 13:31:49.692385 arkitekt-0.4.82/arkitekt/cli/schemas/latest/rekuest.schema.graphql
--rw-r--r--   0        0        0     8943 2023-03-09 13:31:49.696385 arkitekt-0.4.82/arkitekt/cli/schemas/latest/unlok.schema.graphql
--rw-r--r--   0        0        0      208 2023-03-10 15:06:16.963555 arkitekt-0.4.82/arkitekt/cli/templates/simple.py
--rw-r--r--   0        0        0     1302 2023-04-18 10:30:28.953168 arkitekt-0.4.82/arkitekt/cli/types.py
--rw-r--r--   0        0        0     1883 2023-03-10 12:35:52.050986 arkitekt-0.4.82/arkitekt/cli/ui.py
--rw-r--r--   0        0        0      429 2023-03-10 10:47:37.959663 arkitekt-0.4.82/arkitekt/cli/utils.py
--rw-r--r--   0        0        0      271 2023-03-10 11:35:23.703615 arkitekt-0.4.82/arkitekt/deployers/port.py
--rw-r--r--   0        0        0     1910 2022-10-22 17:12:22.527311 arkitekt-0.4.82/arkitekt/healthz.py
--rw-r--r--   0        0        0        0 2022-08-25 11:14:04.331138 arkitekt-0.4.82/arkitekt/qt/__init__.py
--rw-r--r--   0        0        0     6296 2022-08-25 10:31:18.764461 arkitekt-0.4.82/arkitekt/qt/assets/dark/gear.png
--rw-r--r--   0        0        0   105386 2022-08-25 10:31:18.764461 arkitekt-0.4.82/arkitekt/qt/assets/dark/green pulse.gif
--rw-r--r--   0        0        0    94769 2022-08-25 10:31:18.764461 arkitekt-0.4.82/arkitekt/qt/assets/dark/orange pulse.gif
--rw-r--r--   0        0        0   107513 2022-08-25 10:31:18.768461 arkitekt-0.4.82/arkitekt/qt/assets/dark/pink pulse.gif
--rw-r--r--   0        0        0   108749 2022-08-25 10:31:18.768461 arkitekt-0.4.82/arkitekt/qt/assets/dark/red pulse.gif
--rw-r--r--   0        0        0    10710 2022-08-25 10:31:18.768461 arkitekt-0.4.82/arkitekt/qt/assets/light/gear.png
--rw-r--r--   0        0        0   105386 2022-08-25 10:31:18.768461 arkitekt-0.4.82/arkitekt/qt/assets/light/green pulse.gif
--rw-r--r--   0        0        0    94769 2022-08-25 10:31:18.768461 arkitekt-0.4.82/arkitekt/qt/assets/light/orange pulse.gif
--rw-r--r--   0        0        0   107513 2022-08-25 10:31:18.772461 arkitekt-0.4.82/arkitekt/qt/assets/light/pink pulse.gif
--rw-r--r--   0        0        0   108749 2022-08-25 10:31:18.772461 arkitekt-0.4.82/arkitekt/qt/assets/light/red pulse.gif
--rw-r--r--   0        0        0     9166 2023-03-10 11:35:23.703615 arkitekt-0.4.82/arkitekt/qt/magic_bar.py
--rw-r--r--   0        0        0      324 2022-08-25 11:16:26.752819 arkitekt-0.4.82/arkitekt/qt/utils.py
--rw-r--r--   0        0        0    23235 2023-03-09 13:18:29.782260 arkitekt-0.4.82/arkitekt/schemas/latest/fluss.schema.graphql
--rw-r--r--   0        0        0     5187 2023-03-09 13:18:29.814260 arkitekt-0.4.82/arkitekt/schemas/latest/kuay.schema.graphql
--rw-r--r--   0        0        0        0 2023-03-09 13:15:58.729965 arkitekt-0.4.82/arkitekt/schemas/latest/mikro.graphql
--rw-r--r--   0        0        0   100011 2023-03-09 13:18:29.466260 arkitekt-0.4.82/arkitekt/schemas/latest/mikro.schema.graphql
--rw-r--r--   0        0        0        0 2023-03-09 13:16:05.513978 arkitekt-0.4.82/arkitekt/schemas/latest/rekuest.graphql
--rw-r--r--   0        0        0    50701 2023-03-09 13:18:29.570260 arkitekt-0.4.82/arkitekt/schemas/latest/rekuest.schema.graphql
--rw-r--r--   0        0        0     8943 2023-03-09 13:18:29.854260 arkitekt-0.4.82/arkitekt/schemas/latest/unlok.schema.graphql
--rw-r--r--   0        0        0      765 2023-03-17 17:13:40.500701 arkitekt-0.4.82/arkitekt/tqdm.py
--rw-r--r--   0        0        0     4194 2023-03-10 13:41:26.070197 arkitekt-0.4.82/arkitekt/utils.py
--rw-r--r--   0        0        0     1879 2023-04-18 14:49:04.533945 arkitekt-0.4.82/pyproject.toml
--rw-r--r--   0        0        0      939 1970-01-01 00:00:00.000000 arkitekt-0.4.82/PKG-INFO
...
### Comparing `arkitekt-0.4.82/arkitekt/apps/default.py` & `arkitekt-0.4.9/arkitekt/apps/default.py`

 * *Files identical despite different names*

### Comparing `arkitekt-0.4.82/arkitekt/apps/fluss.py` & `arkitekt-0.4.9/arkitekt/apps/fluss.py`
...
### Comparing `arkitekt-0.4.82/arkitekt/apps/mikro.py` & `arkitekt-0.4.9/arkitekt/apps/mikro.py`
...
### Comparing `arkitekt-0.4.82/arkitekt/apps/rekuest.py` & `arkitekt-0.4.9/arkitekt/apps/rekuest.py`

 * *Files identical despite different names*

### Comparing `arkitekt-0.4.82/arkitekt/apps/unlok.py` & `arkitekt-0.4.9/arkitekt/apps/unlok.py`
...
### Comparing `arkitekt-0.4.82/arkitekt/cli/gen.py` & `arkitekt-0.4.9/arkitekt/cli/gen.py`
...
### Comparing `arkitekt-0.4.82/arkitekt/healthz.py` & `arkitekt-0.4.9/arkitekt/healthz.py`

 * *Files identical despite different names*

### Comparing `arkitekt-0.4.82/arkitekt/qt/assets/dark/gear.png` & `arkitekt-0.4.9/arkitekt/qt/assets/dark/gear.png`

 * *Files identical despite different names*

### Comparing `arkitekt-0.4.82/arkitekt/qt/assets/dark/green pulse.gif` & `arkitekt-0.4.9/arkitekt/qt/assets/dark/green pulse.gif`

 * *Files identical despite different names*

### Comparing `arkitekt-0.4.82/arkitekt/qt/assets/dark/orange pulse.gif` & `arkitekt-0.4.9/arkitekt/qt/assets/dark/orange pulse.gif`

 * *Files identical despite different names*

### Comparing `arkitekt-0.4.82/arkitekt/qt/assets/dark/pink pulse.gif` & `arkitekt-0.4.9/arkitekt/qt/assets/dark/pink pulse.gif`

 * *Files identical despite different names*

### Comparing `arkitekt-0.4.82/arkitekt/qt/assets/dark/red pulse.gif` & `arkitekt-0.4.9/arkitekt/qt/assets/dark/red pulse.gif`

 * *Files identical despite different names*

### Comparing `arkitekt-0.4.82/arkitekt/qt/assets/light/gear.png` & `arkitekt-0.4.9/arkitekt/qt/assets/light/gear.png`

 * *Files identical despite different names*

### Comparing `arkitekt-0.4.82/arkitekt/qt/assets/light/green pulse.gif` & `arkitekt-0.4.9/arkitekt/qt/assets/light/green pulse.gif`

 * *Files identical despite different names*

### Comparing `arkitekt-0.4.82/arkitekt/qt/assets/light/orange pulse.gif` & `arkitekt-0.4.9/arkitekt/qt/assets/light/orange pulse.gif`

 * *Files identical despite different names*

### Comparing `arkitekt-0.4.82/arkitekt/qt/assets/light/pink pulse.gif` & `arkitekt-0.4.9/arkitekt/qt/assets/light/pink pulse.gif`

 * *Files identical despite different names*

### Comparing `arkitekt-0.4.82/arkitekt/qt/assets/light/red pulse.gif` & `arkitekt-0.4.9/arkitekt/qt/assets/light/red pulse.gif`

 * *Files identical despite different names*

### Comparing `arkitekt-0.4.82/arkitekt/qt/magic_bar.py` & `arkitekt-0.4.9/arkitekt/qt/magic_bar.py`
...
### Comparing `arkitekt-0.4.82/PKG-INFO` & `arkitekt-0.4.9/PKG-INFO`
