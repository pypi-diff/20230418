# Comparing `tmp/readonly-0.1.0.tar.gz` & `tmp/readonly-0.1.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "readonly-0.1.0.tar", max compression
+gzip compressed data, was "readonly-0.1.1.tar", max compression
```

## Comparing `readonly-0.1.0.tar` & `readonly-0.1.1.tar`

### file list

```diff
@@ -1,7 +1,7 @@
--rw-r--r--   0        0        0     1614 2023-04-17 21:40:45.487797 readonly-0.1.0/LICENSE
--rw-r--r--   0        0        0     4232 2023-04-17 22:14:46.723013 readonly-0.1.0/README.rst
--rw-r--r--   0        0        0     1101 2023-04-17 21:45:40.885693 readonly-0.1.0/pyproject.toml
--rw-r--r--   0        0        0      195 2023-04-17 21:57:01.446107 readonly-0.1.0/readonly/__init__.py
--rw-r--r--   0        0        0      588 2023-04-17 21:52:10.872217 readonly-0.1.0/readonly/readonly.py
--rw-r--r--   0        0        0     5025 1970-01-01 00:00:00.000000 readonly-0.1.0/setup.py
--rw-r--r--   0        0        0     5166 1970-01-01 00:00:00.000000 readonly-0.1.0/PKG-INFO
...
### Comparing `readonly-0.1.0/LICENSE` & `readonly-0.1.1/LICENSE`

 * *Files identical despite different names*

### Comparing `readonly-0.1.0/README.rst` & `readonly-0.1.1/README.rst`
...
### Comparing `readonly-0.1.0/pyproject.toml` & `readonly-0.1.1/pyproject.toml`
...
### Comparing `readonly-0.1.0/readonly/readonly.py` & `readonly-0.1.1/readonly/readonly.py`

 * *Files identical despite different names*

### Comparing `readonly-0.1.0/setup.py` & `readonly-0.1.1/setup.py`
...
### Comparing `readonly-0.1.0/PKG-INFO` & `readonly-0.1.1/PKG-INFO`
