# Comparing `tmp/onnx2tf-1.9.6.tar.gz` & `tmp/onnx2tf-1.9.7.tar.gz`
...
### Comparing `onnx2tf-1.9.6/LICENSE` & `onnx2tf-1.9.7/LICENSE`
...
### Comparing `onnx2tf-1.9.6/onnx2tf/ops/LeakyRelu.py` & `onnx2tf-1.9.7/onnx2tf/ops/LeakyRelu.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Less.py` & `onnx2tf-1.9.7/onnx2tf/ops/Less.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/LessOrEqual.py` & `onnx2tf-1.9.7/onnx2tf/ops/LessOrEqual.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Log.py` & `onnx2tf-1.9.7/onnx2tf/ops/Log.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/LogSoftmax.py` & `onnx2tf-1.9.7/onnx2tf/ops/LogSoftmax.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/LpNormalization.py` & `onnx2tf-1.9.7/onnx2tf/ops/LpNormalization.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/MatMul.py` & `onnx2tf-1.9.7/onnx2tf/ops/MatMul.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/MatMulInteger.py` & `onnx2tf-1.9.7/onnx2tf/ops/MatMulInteger.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Max.py` & `onnx2tf-1.9.7/onnx2tf/ops/Max.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/MaxPool.py` & `onnx2tf-1.9.7/onnx2tf/ops/MaxPool.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/MaxUnpool.py` & `onnx2tf-1.9.7/onnx2tf/ops/MaxUnpool.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Mean.py` & `onnx2tf-1.9.7/onnx2tf/ops/Mean.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/MeanVarianceNormalization.py` & `onnx2tf-1.9.7/onnx2tf/ops/MeanVarianceNormalization.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Min.py` & `onnx2tf-1.9.7/onnx2tf/ops/Min.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Mish.py` & `onnx2tf-1.9.7/onnx2tf/ops/Mish.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Mod.py` & `onnx2tf-1.9.7/onnx2tf/ops/Mod.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Mul.py` & `onnx2tf-1.9.7/onnx2tf/ops/Mul.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Multinomial.py` & `onnx2tf-1.9.7/onnx2tf/ops/Multinomial.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Neg.py` & `onnx2tf-1.9.7/onnx2tf/ops/Neg.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/NonMaxSuppression.py` & `onnx2tf-1.9.7/onnx2tf/ops/NonMaxSuppression.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/NonZero.py` & `onnx2tf-1.9.7/onnx2tf/ops/NonZero.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Not.py` & `onnx2tf-1.9.7/onnx2tf/ops/Not.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/OneHot.py` & `onnx2tf-1.9.7/onnx2tf/ops/OneHot.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Or.py` & `onnx2tf-1.9.7/onnx2tf/ops/Or.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/PRelu.py` & `onnx2tf-1.9.7/onnx2tf/ops/PRelu.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Pad.py` & `onnx2tf-1.9.7/onnx2tf/ops/Pad.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Pow.py` & `onnx2tf-1.9.7/onnx2tf/ops/Pow.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/QLinearAdd.py` & `onnx2tf-1.9.7/onnx2tf/ops/QLinearAdd.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/QLinearConcat.py` & `onnx2tf-1.9.7/onnx2tf/ops/QLinearConcat.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/QLinearConv.py` & `onnx2tf-1.9.7/onnx2tf/ops/QLinearConv.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/QLinearLeakyRelu.py` & `onnx2tf-1.9.7/onnx2tf/ops/QLinearLeakyRelu.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/QLinearMatMul.py` & `onnx2tf-1.9.7/onnx2tf/ops/QLinearMatMul.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/QLinearMul.py` & `onnx2tf-1.9.7/onnx2tf/ops/QLinearMul.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/QLinearSigmoid.py` & `onnx2tf-1.9.7/onnx2tf/ops/QLinearSigmoid.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/QLinearSoftmax.py` & `onnx2tf-1.9.7/onnx2tf/ops/QLinearSoftmax.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/QuantizeLinear.py` & `onnx2tf-1.9.7/onnx2tf/ops/QuantizeLinear.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/RNN.py` & `onnx2tf-1.9.7/onnx2tf/ops/RNN.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/RandomNormal.py` & `onnx2tf-1.9.7/onnx2tf/ops/RandomNormal.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/RandomNormalLike.py` & `onnx2tf-1.9.7/onnx2tf/ops/RandomNormalLike.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/RandomUniform.py` & `onnx2tf-1.9.7/onnx2tf/ops/RandomUniform.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/RandomUniformLike.py` & `onnx2tf-1.9.7/onnx2tf/ops/RandomUniformLike.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Range.py` & `onnx2tf-1.9.7/onnx2tf/ops/Range.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Reciprocal.py` & `onnx2tf-1.9.7/onnx2tf/ops/Reciprocal.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/ReduceL1.py` & `onnx2tf-1.9.7/onnx2tf/ops/ReduceL1.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/ReduceL2.py` & `onnx2tf-1.9.7/onnx2tf/ops/ReduceL2.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/ReduceLogSum.py` & `onnx2tf-1.9.7/onnx2tf/ops/ReduceLogSum.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/ReduceLogSumExp.py` & `onnx2tf-1.9.7/onnx2tf/ops/ReduceLogSumExp.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/ReduceMax.py` & `onnx2tf-1.9.7/onnx2tf/ops/ReduceMax.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/ReduceMean.py` & `onnx2tf-1.9.7/onnx2tf/ops/ReduceMean.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/ReduceMin.py` & `onnx2tf-1.9.7/onnx2tf/ops/ReduceMin.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/ReduceProd.py` & `onnx2tf-1.9.7/onnx2tf/ops/ReduceProd.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/ReduceSum.py` & `onnx2tf-1.9.7/onnx2tf/ops/ReduceSum.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/ReduceSumSquare.py` & `onnx2tf-1.9.7/onnx2tf/ops/ReduceSumSquare.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Relu.py` & `onnx2tf-1.9.7/onnx2tf/ops/Relu.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Reshape.py` & `onnx2tf-1.9.7/onnx2tf/ops/Reshape.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Resize.py` & `onnx2tf-1.9.7/onnx2tf/ops/Resize.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/ReverseSequence.py` & `onnx2tf-1.9.7/onnx2tf/ops/ReverseSequence.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/RoiAlign.py` & `onnx2tf-1.9.7/onnx2tf/ops/RoiAlign.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Round.py` & `onnx2tf-1.9.7/onnx2tf/ops/Round.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/ScaleAndTranslate.py` & `onnx2tf-1.9.7/onnx2tf/ops/ScaleAndTranslate.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Scatter.py` & `onnx2tf-1.9.7/onnx2tf/ops/Scatter.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/ScatterElements.py` & `onnx2tf-1.9.7/onnx2tf/ops/ScatterElements.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/ScatterND.py` & `onnx2tf-1.9.7/onnx2tf/ops/ScatterND.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Selu.py` & `onnx2tf-1.9.7/onnx2tf/ops/Selu.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/SequenceAt.py` & `onnx2tf-1.9.7/onnx2tf/ops/SequenceAt.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/SequenceConstruct.py` & `onnx2tf-1.9.7/onnx2tf/ops/SequenceConstruct.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/SequenceEmpty.py` & `onnx2tf-1.9.7/onnx2tf/ops/SequenceEmpty.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/SequenceErase.py` & `onnx2tf-1.9.7/onnx2tf/ops/SequenceErase.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/SequenceInsert.py` & `onnx2tf-1.9.7/onnx2tf/ops/SequenceInsert.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/SequenceLength.py` & `onnx2tf-1.9.7/onnx2tf/ops/SequenceLength.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Shape.py` & `onnx2tf-1.9.7/onnx2tf/ops/Shape.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Shrink.py` & `onnx2tf-1.9.7/onnx2tf/ops/Shrink.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Sigmoid.py` & `onnx2tf-1.9.7/onnx2tf/ops/Sigmoid.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Sign.py` & `onnx2tf-1.9.7/onnx2tf/ops/Sign.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Sin.py` & `onnx2tf-1.9.7/onnx2tf/ops/Sin.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Sinh.py` & `onnx2tf-1.9.7/onnx2tf/ops/Sinh.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Size.py` & `onnx2tf-1.9.7/onnx2tf/ops/Size.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Slice.py` & `onnx2tf-1.9.7/onnx2tf/ops/Slice.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Softmax.py` & `onnx2tf-1.9.7/onnx2tf/ops/Softmax.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Softplus.py` & `onnx2tf-1.9.7/onnx2tf/ops/Softplus.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Softsign.py` & `onnx2tf-1.9.7/onnx2tf/ops/Softsign.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/SpaceToDepth.py` & `onnx2tf-1.9.7/onnx2tf/ops/SpaceToDepth.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Split.py` & `onnx2tf-1.9.7/onnx2tf/ops/Split.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/SplitToSequence.py` & `onnx2tf-1.9.7/onnx2tf/ops/SplitToSequence.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Sqrt.py` & `onnx2tf-1.9.7/onnx2tf/ops/Sqrt.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Squeeze.py` & `onnx2tf-1.9.7/onnx2tf/ops/Squeeze.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Sub.py` & `onnx2tf-1.9.7/onnx2tf/ops/Sub.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Sum.py` & `onnx2tf-1.9.7/onnx2tf/ops/Sum.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Tan.py` & `onnx2tf-1.9.7/onnx2tf/ops/Tan.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Tanh.py` & `onnx2tf-1.9.7/onnx2tf/ops/Tanh.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/ThresholdedRelu.py` & `onnx2tf-1.9.7/onnx2tf/ops/ThresholdedRelu.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Tile.py` & `onnx2tf-1.9.7/onnx2tf/ops/Tile.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/TopK.py` & `onnx2tf-1.9.7/onnx2tf/ops/TopK.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Transpose.py` & `onnx2tf-1.9.7/onnx2tf/ops/Transpose.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Trilu.py` & `onnx2tf-1.9.7/onnx2tf/ops/Trilu.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Unique.py` & `onnx2tf-1.9.7/onnx2tf/ops/Unique.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Unsqueeze.py` & `onnx2tf-1.9.7/onnx2tf/ops/Unsqueeze.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Upsample.py` & `onnx2tf-1.9.7/onnx2tf/ops/Upsample.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Where.py` & `onnx2tf-1.9.7/onnx2tf/ops/Where.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/Xor.py` & `onnx2tf-1.9.7/onnx2tf/ops/Xor.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/ops/_Loop.py` & `onnx2tf-1.9.7/onnx2tf/ops/_Loop.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/utils/colors.py` & `onnx2tf-1.9.7/onnx2tf/utils/colors.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/utils/common_functions.py` & `onnx2tf-1.9.7/onnx2tf/utils/common_functions.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf/utils/enums.py` & `onnx2tf-1.9.7/onnx2tf/utils/enums.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/onnx2tf.egg-info/PKG-INFO` & `onnx2tf-1.9.7/onnx2tf.egg-info/PKG-INFO`
...
### Comparing `onnx2tf-1.9.6/onnx2tf.egg-info/SOURCES.txt` & `onnx2tf-1.9.7/onnx2tf.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/setup.py` & `onnx2tf-1.9.7/setup.py`

 * *Files identical despite different names*

### Comparing `onnx2tf-1.9.6/tests/test_model_convert.py` & `onnx2tf-1.9.7/tests/test_model_convert.py`
