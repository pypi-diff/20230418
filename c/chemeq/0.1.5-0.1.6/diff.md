# Comparing `tmp/chemeq-0.1.5.tar.gz` & `tmp/chemeq-0.1.6.tar.gz`
...
+gzip compressed data, was "chemeq-0.1.6.tar", last modified: Tue Apr 18 09:27:55 2023, max compression
```

## Comparing `chemeq-0.1.5.tar` & `chemeq-0.1.6.tar`
...
+drwxrwxrwx   0        0        0        0 2023-04-18 09:27:55.279632 chemeq-0.1.6/
+-rw-rw-rw-   0        0        0     1083 2023-04-14 23:38:40.000000 chemeq-0.1.6/LICENSE.txt
+-rw-rw-rw-   0        0        0       41 2023-04-15 14:14:51.000000 chemeq-0.1.6/MANIFEST.in
+-rw-rw-rw-   0        0        0     4866 2023-04-18 09:27:55.279632 chemeq-0.1.6/PKG-INFO
+-rw-rw-rw-   0        0        0     4163 2023-04-18 09:26:20.000000 chemeq-0.1.6/README.md
+-rw-rw-rw-   0        0        0     3839 2023-02-24 23:54:34.000000 chemeq-0.1.6/README.txt
+drwxrwxrwx   0        0        0        0 2023-04-18 09:27:55.269632 chemeq-0.1.6/chemeq/
+-rw-rw-rw-   0        0        0     3781 2023-04-17 09:13:05.000000 chemeq-0.1.6/chemeq/__init__.py
+-rw-rw-rw-   0        0        0     2754 2023-04-13 09:56:06.000000 chemeq-0.1.6/chemeq/count_elements.py
+-rw-rw-rw-   0        0        0    15300 2023-04-17 19:35:13.000000 chemeq-0.1.6/chemeq/equation_balancer.py
+-rw-rw-rw-   0        0        0     2462 2023-04-04 10:17:48.000000 chemeq-0.1.6/chemeq/periodic_table.csv
+-rw-rw-rw-   0        0        0     6512 2023-04-17 19:33:43.000000 chemeq-0.1.6/chemeq/syntax_review.py
+drwxrwxrwx   0        0        0        0 2023-04-18 09:27:55.279632 chemeq-0.1.6/chemeq.egg-info/
+-rw-rw-rw-   0        0        0     4866 2023-04-18 09:27:55.000000 chemeq-0.1.6/chemeq.egg-info/PKG-INFO
+-rw-rw-rw-   0        0        0      491 2023-04-18 09:27:55.000000 chemeq-0.1.6/chemeq.egg-info/SOURCES.txt
+-rw-rw-rw-   0        0        0        1 2023-04-18 09:27:55.000000 chemeq-0.1.6/chemeq.egg-info/dependency_links.txt
+-rw-rw-rw-   0        0        0       13 2023-04-18 09:27:55.000000 chemeq-0.1.6/chemeq.egg-info/requires.txt
+-rw-rw-rw-   0        0        0        7 2023-04-18 09:27:55.000000 chemeq-0.1.6/chemeq.egg-info/top_level.txt
+-rw-rw-rw-   0        0        0      136 2023-04-13 14:13:18.000000 chemeq-0.1.6/pyproject.toml
+-rw-rw-rw-   0        0        0       42 2023-04-18 09:27:55.279632 chemeq-0.1.6/setup.cfg
+-rw-rw-rw-   0        0        0     1211 2023-04-18 09:27:21.000000 chemeq-0.1.6/setup.py
+drwxrwxrwx   0        0        0        0 2023-04-18 09:27:55.279632 chemeq-0.1.6/tests/
+-rw-rw-rw-   0        0        0     2296 2023-04-13 21:31:02.000000 chemeq-0.1.6/tests/test_base_outputs.py
+-rw-rw-rw-   0        0        0     1343 2023-04-14 10:47:52.000000 chemeq-0.1.6/tests/test_syntax.py
```

### Comparing `chemeq-0.1.5/LICENSE.txt` & `chemeq-0.1.6/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `chemeq-0.1.5/PKG-INFO` & `chemeq-0.1.6/PKG-INFO`
...
### Comparing `chemeq-0.1.5/README.md` & `chemeq-0.1.6/README.md`
...
### Comparing `chemeq-0.1.5/README.txt` & `chemeq-0.1.6/README.txt`

 * *Files identical despite different names*

### Comparing `chemeq-0.1.5/chemeq/__init__.py` & `chemeq-0.1.6/chemeq/__init__.py`

 * *Files identical despite different names*

### Comparing `chemeq-0.1.5/chemeq/count_elements.py` & `chemeq-0.1.6/chemeq/count_elements.py`

 * *Files identical despite different names*

### Comparing `chemeq-0.1.5/chemeq/equation_balancer.py` & `chemeq-0.1.6/chemeq/equation_balancer.py`

 * *Files identical despite different names*

### Comparing `chemeq-0.1.5/chemeq/periodic_table.csv` & `chemeq-0.1.6/chemeq/periodic_table.csv`

 * *Files identical despite different names*

### Comparing `chemeq-0.1.5/chemeq/syntax_review.py` & `chemeq-0.1.6/chemeq/syntax_review.py`

 * *Files identical despite different names*

### Comparing `chemeq-0.1.5/chemeq.egg-info/PKG-INFO` & `chemeq-0.1.6/chemeq.egg-info/PKG-INFO`
...
### Comparing `chemeq-0.1.5/setup.py` & `chemeq-0.1.6/setup.py`
...
### Comparing `chemeq-0.1.5/tests/test_base_outputs.py` & `chemeq-0.1.6/tests/test_base_outputs.py`

 * *Files identical despite different names*

### Comparing `chemeq-0.1.5/tests/test_syntax.py` & `chemeq-0.1.6/tests/test_syntax.py`
