# Comparing `tmp/cdktf-surreal-backend-1.0.83.tar.gz` & `tmp/cdktf-surreal-backend-1.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "cdktf-surreal-backend-1.0.83.tar", last modified: Tue Apr 18 00:19:12 2023, max compression
+gzip compressed data, was "cdktf-surreal-backend-1.0.9.tar", last modified: Tue Jan 31 01:14:28 2023, max compression
```

## Comparing `cdktf-surreal-backend-1.0.83.tar` & `cdktf-surreal-backend-1.0.9.tar`

### file list

```diff
@@ -1,21 +1,21 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-18 00:19:12.215551 cdktf-surreal-backend-1.0.83/
--rw-r--r--   0 runner    (1001) docker     (123)    11358 2023-04-18 00:18:57.000000 cdktf-surreal-backend-1.0.83/LICENSE
--rw-r--r--   0 runner    (1001) docker     (123)       23 2023-04-18 00:18:57.000000 cdktf-surreal-backend-1.0.83/MANIFEST.in
--rw-r--r--   0 runner    (1001) docker     (123)     2254 2023-04-18 00:19:12.215551 cdktf-surreal-backend-1.0.83/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     1255 2023-04-18 00:18:57.000000 cdktf-surreal-backend-1.0.83/README.md
--rw-r--r--   0 runner    (1001) docker     (123)      234 2023-04-18 00:18:57.000000 cdktf-surreal-backend-1.0.83/pyproject.toml
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-04-18 00:19:12.215551 cdktf-surreal-backend-1.0.83/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)     1874 2023-04-18 00:18:57.000000 cdktf-surreal-backend-1.0.83/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-18 00:19:12.215551 cdktf-surreal-backend-1.0.83/src/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-18 00:19:12.215551 cdktf-surreal-backend-1.0.83/src/cdktf_surreal-backend/
--rw-r--r--   0 runner    (1001) docker     (123)     7404 2023-04-18 00:18:57.000000 cdktf-surreal-backend-1.0.83/src/cdktf_surreal-backend/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-18 00:19:12.215551 cdktf-surreal-backend-1.0.83/src/cdktf_surreal-backend/_jsii/
--rw-r--r--   0 runner    (1001) docker     (123)      432 2023-04-18 00:18:57.000000 cdktf-surreal-backend-1.0.83/src/cdktf_surreal-backend/_jsii/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)    10996 2023-04-18 00:18:57.000000 cdktf-surreal-backend-1.0.83/src/cdktf_surreal-backend/_jsii/cdktf-surreal-backend@1.0.83.jsii.tgz
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-04-18 00:18:57.000000 cdktf-surreal-backend-1.0.83/src/cdktf_surreal-backend/py.typed
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-18 00:19:12.215551 cdktf-surreal-backend-1.0.83/src/cdktf_surreal_backend.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     2254 2023-04-18 00:19:12.000000 cdktf-surreal-backend-1.0.83/src/cdktf_surreal_backend.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      484 2023-04-18 00:19:12.000000 cdktf-surreal-backend-1.0.83/src/cdktf_surreal_backend.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-04-18 00:19:12.000000 cdktf-surreal-backend-1.0.83/src/cdktf_surreal_backend.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)      107 2023-04-18 00:19:12.000000 cdktf-surreal-backend-1.0.83/src/cdktf_surreal_backend.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)       22 2023-04-18 00:19:12.000000 cdktf-surreal-backend-1.0.83/src/cdktf_surreal_backend.egg-info/top_level.txt
...
### Comparing `cdktf-surreal-backend-1.0.83/LICENSE` & `cdktf-surreal-backend-1.0.9/LICENSE`

 * *Files identical despite different names*

### Comparing `cdktf-surreal-backend-1.0.83/PKG-INFO` & `cdktf-surreal-backend-1.0.9/PKG-INFO`
...
### Comparing `cdktf-surreal-backend-1.0.83/README.md` & `cdktf-surreal-backend-1.0.9/README.md`

 * *Files identical despite different names*

### Comparing `cdktf-surreal-backend-1.0.83/setup.py` & `cdktf-surreal-backend-1.0.9/setup.py`
...
@@ -22,38 +22,37 @@
     ...
     "package_data": {
         "cdktf_surreal-backend._jsii": [
-            "cdktf-surreal-backend@1.0.83.jsii.tgz"
...
### Comparing `cdktf-surreal-backend-1.0.83/src/cdktf_surreal-backend/__init__.py` & `cdktf-surreal-backend-1.0.9/src/cdktf_surreal-backend/__init__.py`

 * *Files identical despite different names*

### Comparing `cdktf-surreal-backend-1.0.83/src/cdktf_surreal_backend.egg-info/PKG-INFO` & `cdktf-surreal-backend-1.0.9/src/cdktf_surreal_backend.egg-info/PKG-INFO`
