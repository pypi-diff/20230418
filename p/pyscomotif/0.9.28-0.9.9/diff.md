# Comparing `tmp/pyscomotif-0.9.28.tar.gz` & `tmp/pyscomotif-0.9.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "pyscomotif-0.9.28.tar", last modified: Tue Apr 18 08:37:32 2023, max compression
+gzip compressed data, was "pyscomotif-0.9.9.tar", last modified: Mon Feb 20 09:32:55 2023, max compression
```

## Comparing `pyscomotif-0.9.28.tar` & `pyscomotif-0.9.9.tar`

### file list

```diff
@@ -1,14 +1,13 @@
--rw-r--r--   0        0        0     8494 2023-04-18 08:36:52.225555 pyscomotif-0.9.28/README.md
--rw-r--r--   0        0        0      548 2023-04-18 08:36:42.929430 pyscomotif-0.9.28/pyproject.toml
--rw-r--r--   0        0        0     6901 2023-02-20 08:49:49.687463 pyscomotif-0.9.28/src/pyscomotif/RMSD_calculation.py
--rw-r--r--   0        0        0       88 2023-03-16 13:39:17.205069 pyscomotif-0.9.28/src/pyscomotif/__init__.py
--rw-r--r--   0        0        0     1251 2023-02-20 08:50:03.155529 pyscomotif-0.9.28/src/pyscomotif/constants.py
--rw-r--r--   0        0        0      857 2022-12-21 08:28:41.224270 pyscomotif-0.9.28/src/pyscomotif/data_containers.py
--rw-r--r--   0        0        0     1326 2023-01-27 13:49:21.652224 pyscomotif-0.9.28/src/pyscomotif/index_folders_and_files.py
--rw-r--r--   0        0        0    11849 2023-03-06 10:21:16.803622 pyscomotif-0.9.28/src/pyscomotif/indexing.py
--rw-r--r--   0        0        0    33394 2023-03-23 10:39:00.074208 pyscomotif-0.9.28/src/pyscomotif/motif_search.py
--rw-r--r--   0        0        0    36856 2023-02-20 08:49:49.687463 pyscomotif-0.9.28/src/pyscomotif/motif_search_with_ShareableList.py
--rw-r--r--   0        0        0    13395 2023-04-18 08:36:54.785589 pyscomotif-0.9.28/src/pyscomotif/pyscomotif.py
--rw-r--r--   0        0        0     7377 2023-02-27 14:14:03.695109 pyscomotif-0.9.28/src/pyscomotif/residue_data_dicts.py
--rw-r--r--   0        0        0     4320 2023-04-14 07:43:37.246808 pyscomotif-0.9.28/src/pyscomotif/utils.py
--rw-r--r--   0        0        0     9033 1970-01-01 00:00:00.000000 pyscomotif-0.9.28/PKG-INFO
...
### Comparing `pyscomotif-0.9.28/pyproject.toml` & `pyscomotif-0.9.9/pyproject.toml`
...
### Comparing `pyscomotif-0.9.28/src/pyscomotif/RMSD_calculation.py` & `pyscomotif-0.9.9/src/pyscomotif/RMSD_calculation.py`

 * *Files identical despite different names*

### Comparing `pyscomotif-0.9.28/src/pyscomotif/constants.py` & `pyscomotif-0.9.9/src/pyscomotif/constants.py`

 * *Files identical despite different names*

### Comparing `pyscomotif-0.9.28/src/pyscomotif/data_containers.py` & `pyscomotif-0.9.9/src/pyscomotif/data_containers.py`

 * *Files identical despite different names*

### Comparing `pyscomotif-0.9.28/src/pyscomotif/index_folders_and_files.py` & `pyscomotif-0.9.9/src/pyscomotif/index_folders_and_files.py`

 * *Files identical despite different names*

### Comparing `pyscomotif-0.9.28/src/pyscomotif/indexing.py` & `pyscomotif-0.9.9/src/pyscomotif/indexing.py`

 * *Files identical despite different names*

### Comparing `pyscomotif-0.9.28/src/pyscomotif/motif_search.py` & `pyscomotif-0.9.9/src/pyscomotif/motif_search_with_ShareableList.py`
...
### Comparing `pyscomotif-0.9.28/src/pyscomotif/motif_search_with_ShareableList.py` & `pyscomotif-0.9.9/src/pyscomotif/motif_search.py`
...
### Comparing `pyscomotif-0.9.28/src/pyscomotif/pyscomotif.py` & `pyscomotif-0.9.9/src/pyscomotif/pyscomotif.py`
...
### Comparing `pyscomotif-0.9.28/src/pyscomotif/residue_data_dicts.py` & `pyscomotif-0.9.9/src/pyscomotif/residue_data_dicts.py`
...
### Comparing `pyscomotif-0.9.28/src/pyscomotif/utils.py` & `pyscomotif-0.9.9/src/pyscomotif/utils.py`
