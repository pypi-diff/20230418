# Comparing `tmp/poectrl-0.4.0.tar.gz` & `tmp/poectrl-0.4.1.tar.gz`
...
+gzip compressed data, was "poectrl-0.4.1.tar", max compression
```

## Comparing `poectrl-0.4.0.tar` & `poectrl-0.4.1.tar`
...
+-rw-r--r--   0        0        0     1069 2022-12-13 13:10:09.884351 poectrl-0.4.1/LICENSE.txt
+-rw-r--r--   0        0        0     5633 2023-04-18 15:07:45.235401 poectrl-0.4.1/README.md
+-rw-r--r--   0        0        0        0 2022-12-13 17:24:57.939711 poectrl-0.4.1/poectrl/__init__.py
+-rw-r--r--   0        0        0        0 2022-12-26 18:52:39.232609 poectrl-0.4.1/poectrl/api/__init__.py
+-rw-r--r--   0        0        0      386 2022-12-26 18:52:39.232609 poectrl-0.4.1/poectrl/api/main.py
+-rw-r--r--   0        0        0     2024 2022-12-26 18:52:39.232609 poectrl-0.4.1/poectrl/api/managers/PoE.py
+-rw-r--r--   0        0        0        0 2022-12-26 18:52:39.232609 poectrl-0.4.1/poectrl/api/resources/__init__.py
+-rw-r--r--   0        0        0      773 2022-12-26 18:52:39.232609 poectrl-0.4.1/poectrl/api/resources/control.py
+-rw-r--r--   0        0        0      227 2022-12-26 18:52:39.232609 poectrl-0.4.1/poectrl/api/resources/home.py
+-rw-r--r--   0        0        0        0 2022-12-26 18:52:39.232609 poectrl-0.4.1/poectrl/api/schemas/__init__.py
+-rw-r--r--   0        0        0      543 2022-12-26 18:52:39.236609 poectrl-0.4.1/poectrl/api/schemas/base.py
+-rw-r--r--   0        0        0        0 2022-12-26 18:52:39.236609 poectrl-0.4.1/poectrl/api/schemas/request/__init__.py
+-rw-r--r--   0        0        0        0 2022-12-26 18:52:39.236609 poectrl-0.4.1/poectrl/api/schemas/response/__init__.py
+-rw-r--r--   0        0        0      295 2022-12-26 18:52:39.236609 poectrl-0.4.1/poectrl/api/schemas/response/poe.py
+-rw-r--r--   0        0        0      671 2022-12-26 18:52:39.236609 poectrl-0.4.1/poectrl/api/settings.py
+-rw-r--r--   0        0        0     6982 2022-12-26 18:52:39.236609 poectrl-0.4.1/poectrl/base.py
+-rw-r--r--   0        0        0     4071 2023-04-18 15:07:45.235401 poectrl-0.4.1/poectrl/cliapp.py
+-rw-r--r--   0        0        0      906 2022-12-13 17:24:57.943711 poectrl-0.4.1/poectrl/errors.py
+-rwxr-xr-x   0        0        0     1192 2023-04-18 15:28:03.953822 poectrl-0.4.1/poectrl/main.py
+-rw-r--r--   0        0        0     2629 2022-12-26 18:52:39.236609 poectrl-0.4.1/poectrl/profiles.py
+-rw-r--r--   0        0        0     2077 2022-12-13 17:24:57.943711 poectrl-0.4.1/poectrl/sshwrapper.py
+-rw-r--r--   0        0        0     1432 2023-04-18 15:28:24.553706 poectrl-0.4.1/pyproject.toml
+-rw-r--r--   0        0        0     6813 1970-01-01 00:00:00.000000 poectrl-0.4.1/setup.py
+-rw-r--r--   0        0        0     7107 1970-01-01 00:00:00.000000 poectrl-0.4.1/PKG-INFO
```

### Comparing `poectrl-0.4.0/LICENSE.txt` & `poectrl-0.4.1/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `poectrl-0.4.0/README.md` & `poectrl-0.4.1/README.md`

 * *Files identical despite different names*

### Comparing `poectrl-0.4.0/poectrl/api/managers/PoE.py` & `poectrl-0.4.1/poectrl/api/managers/PoE.py`

 * *Files identical despite different names*

### Comparing `poectrl-0.4.0/poectrl/api/resources/control.py` & `poectrl-0.4.1/poectrl/api/resources/control.py`

 * *Files identical despite different names*

### Comparing `poectrl-0.4.0/poectrl/api/schemas/base.py` & `poectrl-0.4.1/poectrl/api/schemas/base.py`

 * *Files identical despite different names*

### Comparing `poectrl-0.4.0/poectrl/api/settings.py` & `poectrl-0.4.1/poectrl/api/settings.py`

 * *Files identical despite different names*

### Comparing `poectrl-0.4.0/poectrl/base.py` & `poectrl-0.4.1/poectrl/base.py`

 * *Files identical despite different names*

### Comparing `poectrl-0.4.0/poectrl/cliapp.py` & `poectrl-0.4.1/poectrl/cliapp.py`

 * *Files identical despite different names*

### Comparing `poectrl-0.4.0/poectrl/errors.py` & `poectrl-0.4.1/poectrl/errors.py`

 * *Files identical despite different names*

### Comparing `poectrl-0.4.0/poectrl/profiles.py` & `poectrl-0.4.1/poectrl/profiles.py`

 * *Files identical despite different names*

### Comparing `poectrl-0.4.0/poectrl/sshwrapper.py` & `poectrl-0.4.1/poectrl/sshwrapper.py`

 * *Files identical despite different names*

### Comparing `poectrl-0.4.0/pyproject.toml` & `poectrl-0.4.1/pyproject.toml`
...
### Comparing `poectrl-0.4.0/setup.py` & `poectrl-0.4.1/setup.py`
...
### Comparing `poectrl-0.4.0/PKG-INFO` & `poectrl-0.4.1/PKG-INFO`
