# Comparing `tmp/decode-config-12.5.0.0.tar.gz` & `tmp/decode-config-2022.1.tar.gz`
...
### Comparing `decode-config-12.5.0.0/decode_config.egg-info/PKG-INFO` & `decode-config-2022.1/README.md`
