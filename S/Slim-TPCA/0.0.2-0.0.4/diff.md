# Comparing `tmp/Slim-TPCA-0.0.2.tar.gz` & `tmp/Slim-TPCA-0.0.4.tar.gz`
...
## Comparing `Slim-TPCA-0.0.2.tar` & `Slim-TPCA-0.0.4.tar`
...
### Comparing `Slim-TPCA-0.0.2/LICENSE` & `Slim-TPCA-0.0.4/LICENSE`

 * *Files identical despite different names*

### Comparing `Slim-TPCA-0.0.2/PKG-INFO` & `Slim-TPCA-0.0.4/PKG-INFO`
...
### Comparing `Slim-TPCA-0.0.2/README.md` & `Slim-TPCA-0.0.4/README.md`

 * *Files identical despite different names*

### Comparing `Slim-TPCA-0.0.2/pyproject.toml` & `Slim-TPCA-0.0.4/pyproject.toml`
...
### Comparing `Slim-TPCA-0.0.2/src/Slim_TPCA.egg-info/PKG-INFO` & `Slim-TPCA-0.0.4/Slim_TPCA.egg-info/PKG-INFO`
